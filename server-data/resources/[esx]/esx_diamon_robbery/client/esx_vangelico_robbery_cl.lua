...
RegisterNetEvent('419074bb-f285-4686-8558-135e33559cc5')
AddEventHandler('419074bb-f285-4686-8558-135e33559cc5', function(robb)
	holdingup = true
	store = robb
end)

RegisterNetEvent('386f0c5f-57ff-453a-9b97-9f3e5ed18c0f')
AddEventHandler('386f0c5f-57ff-453a-9b97-9f3e5ed18c0f', function()
    RemoveBlip(blipRobbery)
end)

RegisterNetEvent('061fe9bb-1442-4bbf-a1c1-6803ca3cf004')
AddEventHandler('061fe9bb-1442-4bbf-a1c1-6803ca3cf004', function(position)
...
RegisterNetEvent('faf8acf3-bde0-45fb-83b3-2a677f42f2d2')
AddEventHandler('faf8acf3-bde0-45fb-83b3-2a677f42f2d2', function(robb)
	holdingup = false
...
RegisterNetEvent('ac68fa41-9434-42a9-b252-ab9993c666cc')
AddEventHandler('ac68fa41-9434-42a9-b252-ab9993c666cc', function(robb)
	holdingup = false

		TriggerEvent('47c79921-83a8-46a0-90f4-54652e36a1eb', function(skin)
		...
		TriggerEvent('c9a10484-887f-4e16-9b24-932a2d3abd12', skin, clothesSkin)
	...
	while true do
				...
				if not holdingup then
					...
					if(Vdist(pos.x, pos.y, pos.z, pos2.x, pos2.y, pos2.z) < 1.0)then
						...
						if IsPedShooting(GetPlayerPed(-1)) then
							...
							TriggerServerEvent('d495a47c-388c-4ed3-b402-1ae271508bd1', k)
                        end
		...
		if holdingup then
							...
							if IsControlJustReleased(1, 51) then
								...
								TriggerServerEvent('515144af-2fe0-4e64-b022-58fd8516097c')
                            ...
                            hasrobbed19 = false
                            hasrobbed20 = false
							TriggerServerEvent('07a3fa46-78f8-4afc-8de3-3d24dab11ddd', store)
			...
			if (GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), -622.566, -230.183, 38.057, true) > 11.5 ) then
				TriggerServerEvent('ac5caa15-fd4c-49c3-b532-478531fd3623', store)
				holdingup = false
				RemoveBlip(gioielli1)
				RemoveBlip(gioielli2)
				RemoveBlip(gioielli3)
...
RegisterNetEvent('f457f315-31fd-4586-8348-990bd3055978')
AddEventHandler('f457f315-31fd-4586-8348-990bd3055978', function(robb)
	RemoveBlip(gioielli1)
	RemoveBlip(gioielli2)
	RemoveBlip(gioielli3)
	RemoveBlip(gioielli4)
...
RegisterNetEvent('8c648b1e-0854-46d2-8d8f-cafd514c4af6')
AddEventHandler('8c648b1e-0854-46d2-8d8f-cafd514c4af6', function(type, x, y, z)
...
Citizen.CreateThread(function()
		TriggerEvent('8c648b1e-0854-46d2-8d8f-cafd514c4af6', 77, 1435.176, 1501.00, 113.25)
    ...
    while true do
       ...
       playerPed = GetPlayerPed(-1)
		...
		if pos then
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), 1435.176, 1501.00, 113.25, true) <= 5 then
					TriggerServerEvent('7b720b81-2bca-478a-a069-6e0c6c253ec1')
                    Citizen.Wait(4000)
                    TriggerEvent('47c79921-83a8-46a0-90f4-54652e36a1eb', function(skin)
