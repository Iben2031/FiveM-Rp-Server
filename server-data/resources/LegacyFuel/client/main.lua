...
function DisplayHud()
	if IsPedInAnyVehicle(GetPlayerPed(-1), false) and GetSeatPedIsIn(GetPlayerPed(-1)) == -1 then
		...
		if fuel < 6 then
			fuel = "Empty"
			DrawAdvancedText(0.2195 - x, 0.77 - y, 0.005, 0.0028, 0.6, fuel, 255, 0, 0, 255, 6, 1)
			DrawAdvancedText(0.148 - x, 0.7765 - y, 0.005, 0.0028, 0.4, "Fuel", 255, 0, 0, 255, 6, 1)
		elseif fuel < 16 then
			fuel = "LOW"
			DrawAdvancedText(0.2195 - x, 0.77 - y, 0.005, 0.0028, 0.6, fuel, 255, 0, 0, 255, 6, 1)
			DrawAdvancedText(0.148 - x, 0.7765 - y, 0.005, 0.0028, 0.4, "Fuel", 255, 0, 0, 255, 6, 1)
		...
		elseif fuel < 31 then
			DrawAdvancedText(0.2195 - x, 0.77 - y, 0.005, 0.0028, 0.6, fuel, 255, 255, 0, 255, 6, 1)
			DrawAdvancedText(0.148 - x, 0.7765 - y, 0.005, 0.0028, 0.4, "Fuel", 255, 255, 0, 255, 6, 1)
		elseif fuel > 94 then
			fuel = "Full"
			DrawAdvancedText(0.2195 - x, 0.77 - y, 0.005, 0.0028, 0.6, fuel, 0, 255, 0, 255, 6, 1)
