...
RegisterNetEvent('b6e57067-9414-4cc5-b5c3-02f85ea79b65')
AddEventHandler('b6e57067-9414-4cc5-b5c3-02f85ea79b65', function()
	local vehicle = GetVehiclePedIsIn(GetPlayerPed(-1), false)
	myCar = ESX.Game.GetVehicleProperties(vehicle)
	TriggerServerEvent('fb5e7259-141f-4522-8a53-7b06a7691f6b', myCar)
end)

RegisterNetEvent('5e652077-a0f0-4cc6-86c0-2d5ab119a808')
AddEventHandler('5e652077-a0f0-4cc6-86c0-2d5ab119a808', function()
	local vehicle = GetVehiclePedIsIn(GetPlayerPed(-1), false)
...
function OpenLSMenu(elems, menuname, menutitle, parent)
	...
	ESX.UI.Menu.Open(
			...
			for k,v in pairs(Config.Menus) do
				if k == data.current.modType or isRimMod then
					if data.current.label == _U('by_default') or string.match(data.current.label, _U('installed')) then
						...
						if isRimMod then
							TriggerServerEvent('1ffac387-0ea5-49bf-96c5-013d59b99a47', data.current.price)
						else
							TriggerServerEvent('1ffac387-0ea5-49bf-96c5-013d59b99a47', v.price)
						end
					end
					menu.close()
					found = true
		...
		function(data, menu) -- on cancel
			menu.close()
			TriggerEvent('5e652077-a0f0-4cc6-86c0-2d5ab119a808')
			if parent == nil then
